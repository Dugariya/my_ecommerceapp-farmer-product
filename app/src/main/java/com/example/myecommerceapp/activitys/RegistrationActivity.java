...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate ( Bundle savedInstanceState ) {
      ...
      /*  if (isFirstTime){
            ...
            // Intent intent= new Intent(RegistorActivity.this, OnBoardingActivity.class);
    ...
    public void signUp ( View view ) {
        ...
        if (userPassword.length()<6) {
            ...
            Toast.makeText( this, "Enter Password length to short ,Enter Minimum 6 characters", Toast.LENGTH_SHORT ).show();
            return;
        }
        ...
        // startActivity( new Intent(RegistorActivity.this,MainActivity.class) );
    }
